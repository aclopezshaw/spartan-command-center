...
flowchart LR
    ...
    R060 --> E060A["0.6.0 Campaign Event Reliability<br/>11 tickets"]
    ...
    R060 --> E060E["0.6.0 Engineering Baseline & Governance<br/>6 tickets"]

    R061 --> E061A["0.6.1 Intelligence Reporting<br/>1 ticket"]
    R061 --> E061B["0.6.1 Academic Operations Core & SMU Reliability<br/>9 tickets"]
    R061 --> E061C["0.6.1 Daily & Weekly Operations Reliability<br/>4 tickets"]
    R061 --> E061D["📱 0.6.1 Cross-Surface Operational Consistency<br/>11 tickets"]
    ...
    class E060A,E060B,E060C,E060D,E060E,E061A,E061B,E061C,E061D,E061E,E062A,E062B,E062C,E062D,E062E epic;
```
...
flowchart LR
    ...
    R070 --> E070B["0.7.0 Fireteam Identity & Dossiers<br/>4 tickets"]
...
flowchart LR
    ...
    R100 --> E100A["1.0.0 Graduation & Operational Identity<br/>3 tickets"]
    ...
    R103 --> E103B["1.0.3 Armory Skill Tree & Economy<br/>2 tickets"]
...
- Release Operations and the Spartan Dev Command Board — names, parent relations, and direct epic ticket counts verified on 2026-07-15.
