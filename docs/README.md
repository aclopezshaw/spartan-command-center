...
**Last repository review:** 2026-07-26
...
- [Notion Integration](NOTION_INTEGRATION.md) — server boundary, configuration inventory, read/write flows, and schema-change workflow.
